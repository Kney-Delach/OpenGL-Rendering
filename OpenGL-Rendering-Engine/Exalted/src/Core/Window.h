...
namespace Exalted
{
	struct WindowProperties
	{
		...
		WindowProperties(const std::string& title = "OpenGL Rendering Showcase", unsigned int width = 2560, unsigned int height = 1440)//unsigned int width = 1920, unsigned int height = 1080)
