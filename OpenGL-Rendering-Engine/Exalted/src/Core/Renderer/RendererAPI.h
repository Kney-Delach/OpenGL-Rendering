...
namespace Exalted 
{
	...
	public:
		...
		virtual void DrawTessellatedInstanced(const Ref<Mesh>& mesh, unsigned long long& quantity) = 0;
		virtual void DrawTessellatedTrianglesInstanced(int numberOfVertices, unsigned long long& quantity) = 0;
	public:
