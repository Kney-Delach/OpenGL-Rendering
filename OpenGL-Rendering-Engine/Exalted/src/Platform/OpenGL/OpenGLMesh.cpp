...
namespace Exalted
{
	void OpenGLMesh::CreateTriangle()
	{
		...
		vertexBuffer = VertexBuffer::Create(vertices, 3*7);
	...
	void OpenGLMesh::CreateQuad()
	{
		...
		Ref<VertexBuffer> vertexBuffer;
		vertexBuffer = VertexBuffer::Create(vertices, 4*7);
		const BufferLayout layout =
		{ 
			{ShaderDataType::Float3, "a_Position"},
			{ShaderDataType::Float4, "a_Colour" }
	...
	void OpenGLMesh::CreateCube()
	{
		...
		Ref<VertexBuffer> vertexBuffer;
		vertexBuffer = VertexBuffer::Create(vertices, 8*7);
		const BufferLayout layout =
		{
			{ShaderDataType::Float3, "a_Position"},
			{ShaderDataType::Float4, "a_Colour" }
	...
	void OpenGLMesh::CreateTexturedQuad(float textureScale)
	{
		...
		Ref<VertexBuffer> vertexBuffer;
		vertexBuffer = VertexBuffer::Create(vertices, 4*9);
		const BufferLayout layout =
		{
			{ShaderDataType::Float3, "a_Position"},
			{ShaderDataType::Float4, "a_Colour" },
	...
	void OpenGLMesh::CreateTexturedCube(float textureScale)
	{
		...
		Ref<VertexBuffer> vertexBuffer;
		vertexBuffer = VertexBuffer::Create(vertices, 6*6*9);
		const BufferLayout layout =
		{
			{ShaderDataType::Float3, "a_Position"},
			{ShaderDataType::Float4, "a_Colour" },
